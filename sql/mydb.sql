...
--
-- Table structure for table `tb_owned_products`
--
...
CREATE TABLE IF NOT EXISTS `tb_products` (
  ...
  `YTLink` varchar(50) COLLATE utf8mb4_unicode_520_ci NOT NULL,
...
--
-- Constraints for table `tb_owned_products`
--
